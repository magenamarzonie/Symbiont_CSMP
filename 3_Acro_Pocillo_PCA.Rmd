...
# ----------------------------------------------------------
Different UniFrac distances impact on dbRDA results
# ----------------------------------------------------------
...
du_pver_0.5 <- unifracs_pver[, , "d_0.5"]
du_pver_w <- unifracs_pver[, , "d_1"]  #can change Unifrac type.- go to GUniFrac in Help section   
du_pver_uw <- unifracs_pver[, , "d_0"] 

dist_pver_0.5 <- as.dist(du_pver_0.5, diag = FALSE)
dist_pver_w <- as.dist(du_pver_w, diag = FALSE)
dist_pver_uw <- as.dist(du_pver_uw, diag = FALSE)
...
ord_pver_0.5 <- dbrda(dist_pver_0.5 ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3  + DHW6, data = adonis_meta_pver, permutations = 9999)
anova(ord_pver_0.5, by = 'margin')   

ord_pver_w <- dbrda(dist_pver_w ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3 + DHW6, data = adonis_meta_pver, permutations = 9999)
anova(ord_pver_w, by = 'margin')   

ord_pver_uw <- dbrda(dist_pver_uw ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3 + DHW6, data = adonis_meta_pver, permutations = 9999)
anova(ord_pver_uw, by = 'margin')   


pver_0.5 <- plot(ord_pver0.5)
pver_w <- plot(ord_pver_w)
pver_uw <- plot(ord_pver_uw)
...
du_pmea_0.5 <- unifracs_pmea[, , "d_0.5"]
du_pmea_w <- unifracs_pmea[, , "d_1"]  #can change Unifrac type.- go to GUniFrac in Help section   
du_pmea_uw <- unifracs_pmea[, , "d_0"] 

dist_pmea_0.5 <- as.dist(du_pmea_0.5, diag = FALSE)
dist_pmea_w <- as.dist(du_pmea_w, diag = FALSE)
dist_pmea_uw <- as.dist(du_pmea_uw, diag = FALSE)
...
ord_pmea_0.5 <- dbrda(dist_pmea_0.5 ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3  + DHW6, data = adonis_meta_pmea, permutations = 9999)
anova(ord_pmea_0.5, by = 'margin')   

ord_pmea_w <- dbrda(dist_pmea_w ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3 + DHW6, data = adonis_meta_pmea, permutations = 9999)
anova(ord_pmea_w, by = 'margin')   

ord_pmea_uw <- dbrda(dist_pmea_uw ~ GPS_S + catBleaching + Exposure + Depth + GPS_E + DHW3 + DHW6, data = adonis_meta_pmea, permutations = 9999)
anova(ord_pmea_uw, by = 'margin')   


pmea_0.5 <- plot(ord_pmea_0.5)
pmea_w <- plot(ord_pmea_w)
pmea_uw <- plot(ord_pmea_uw)
...
du_acro_0.5 <- unifracs_acro[, , "d_0.5"]
du_acro_w <- unifracs_acro[, , "d_1"]  #can change Unifrac type.- go to GUniFrac in Help section   
du_acro_uw <- unifracs_acro[, , "d_0"] 

dist_acro_0.5 <- as.dist(du_acro_0.5, diag = FALSE)
dist_pver_w <- as.dist(du_pver_w, diag = FALSE)
dist_pver_uw <- as.dist(du_pver_uw, diag = FALSE)
