...
sort(vif.cca(ord_pver_full)) # according to vif.cca documentation, values over 10 indicate redundant constraints
...
# Re check the new vic scores
sort(vif.cca(ord_pver))

# Use ordistep to further refine the model
os_pver <- ordistep(ord_pver, direction = "both", trace = FALSE)
anova(os_pver, by = 'margin')
