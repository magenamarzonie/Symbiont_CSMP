...
ord_pver <- dbrda(dist_pver ~ GPS_S + Depth + DHW3 + DHW6 + recent.maxDHW + catBleaching + DHW2020 + varSST, data=adonis_meta_pver)
...
# Reduce the model (consult the corplot and vif scores)
ord_acro <- dbrda(dist_acro ~ GPS_S + Depth + DHW3 + DHW6 + recent.maxDHW + catBleaching + DHW2020 + varSST, data=adonis_meta_acro)
