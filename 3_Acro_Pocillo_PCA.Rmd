...
```{r}
varp = varpart(dist_pver, ~ Depth, ~maxDHW, ~GPS_S, data = adonis_meta_pver)

plot(varp, digits = 2, Xnames = c("Depth", "maxDHW", "GPS_S"), bg = c("navy", "tomato", "orange"))
```
...
```{r}
varp_acro = varpart(dist_acro, ~ DHW3, ~DHW6, ~GPS_S, ~recent.maxDHW,  data = adonis_meta_acro)

plot(varp_acro, digits = 2, Xnames = c("DHW3", "DHW6", "GPS_S", "recent.maxDHW"), bg = c("navy", "tomato", "orange", "green"))
```
