...
ord_pver <- dbrda(dist_pver ~ maxDHW + DHW3 + DHW6 + recent.maxDHW + rangeSST + GPS_S , data=adonis_meta_pver)
...
sort(vif.cca(ord_pmea_full)) 
  # Depth           DHW4           DHW6           DHW9           DHW8         maxDHW 
  #     1.961623       5.524548       6.432968      10.005341      10.535683      11.883727 
  #         DHW3  recent.maxDHW        meanDHW       rangeSST recent.meanDHW         varSST 
  #    12.147581      13.755357      56.646502      67.138168     133.177017     155.900084 
  #        GPS_S            MMM 
  #   216.759822     414.329321 

# Reduce the model (consult the corplot and vif scores)
ord_pmea <- dbrda(dist_pmea ~ Depth + DHW4 , data=adonis_meta_pmea)
