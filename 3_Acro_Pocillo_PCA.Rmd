...
#change site names so they will merge with full_meta 
 site.bleachings2 = site.bleachings %>% mutate(Site = str_extract(Site, ".\\d"),
         Site = paste(abbreviate(Reef), Site, sep='_'),
         Site = gsub(" ", "", Site),
         Site = gsub("Dmnd_1", "Dmnd_East", Site))

full_meta2 = full_meta %>% left_join(site.bleachings2, by = "Site")
```
