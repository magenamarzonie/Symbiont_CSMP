...
ord_pver <- dbrda(dist_pver ~ Depth + DHW3 + DHW6 + recent.maxDHW + varSST + GPS_S, data=adonis_meta_pver)
...
# Reduce the model (consult the corplot and vif scores)
ord_punk <- dbrda(dist_punk ~ Depth + DHW3 + DHW6 + recent.maxDHW + varSST + GPS_S , data=adonis_meta_punk)
...
# Reduce the model (consult the corplot and vif scores)
ord_acro <- dbrda(dist_acro ~ Depth + DHW3 + DHW6 + recent.maxDHW + varSST + GPS_S , data=adonis_meta_acro)
