...
car::vif(lm(1:nrow(adonis_meta_pver) ~ GPS_S  + DHW3 + catBleaching + Depth, data=adonis_meta_pver))
...
ord_pver <- dbrda(dist_pver ~ GPS_S + DHW3 + catBleaching + Depth, data = adonis_meta_pver, permutations = 9999, scale = TRUE)
...
#(fit <- envfit(ord_pver, adonis_meta_pver %>% select(GPS_S + DHW3 + catBleaching + Depth), perm = 999))
...
#dbRDA with all factors 
ord_pmea <- dbrda(dist_pmea ~ GPS_S + varSST + catBleaching + Depth, data = adonis_meta_pmea, permutations = 9999, scale = TRUE)
...
#dbRDA with all factors 
ord_punk <- dbrda(dist_punk ~ GPS_S + varSST + catBleaching + Depth, data = adonis_meta_punk, permutations = 9999)
...
car::vif(lm(1:nrow(adonis_meta_acro) ~ Reef.x + catBleaching + Depth + DHW3, data=adonis_meta_acro)) # REEF
