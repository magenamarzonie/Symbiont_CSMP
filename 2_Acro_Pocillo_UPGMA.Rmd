...
du_pver_w <- unifracs_pver[, , "d_1"] #weighted unifrac
du_pver_uw <- unifracs_pver[, , "d_UW"]    #unweighted unifrac
...
du_pmea_0.5<- unifracs_pmea[, , "d_0.5"]  #can change Unifrac type.- go to GUniFrac in Help section   
du_pmea_w <-  unifracs_pmea[, , "d_1"]
