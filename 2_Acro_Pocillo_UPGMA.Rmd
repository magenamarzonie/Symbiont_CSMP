...
unifracs_poci <- unidist_poci$unifracs_poci
du_poci <- unifracs_poci[, , "d_VAW"]  #can change Unifrac type. slices the typ 
...
tree_tip_poci <- tree_poci + geom_tippoint(aes(color=Species), size=0.3, alpha=1) +
...
unifracs_acro <- unidist_acro$unifracs_acro
du_acro <- unifracs_acro[, , "d_VAW"]  #can change Unifrac type. slices the typ 
