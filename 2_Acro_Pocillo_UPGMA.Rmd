...
tree_tip_poci <- tree_poci + geom_tippoint(aes(color=Reef.x), size=0.3, alpha=1) +
...
tree_tip_pver <- tree_pver + geom_tippoint(aes(color=Reef.x), size=0.3, alpha=1) +
  scale_color_d3(palette = "category20")
...
tree_tip_pmea <- tree_pmea + geom_tippoint(aes(color=Reef.x), size=0.3, alpha=1) +
  scale_color_d3(palette = "category20")
...
tree_tip_punk <- tree_punk + geom_tippoint(aes(color=Reef.x), size=0.3, alpha=1) +
  scale_color_d3(palette = "category20")
...
tree_tip_acro <- tree_acro + geom_tippoint(aes(color=Reef.x), size=0.3, alpha=1) +
  scale_color_d3(palette = "category20")
